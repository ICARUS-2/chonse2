...
import { PgnFields, PgnHeaders, SanMove } from "../../../../app/chessboard/chessboard/pgn-misc";
import MoveResult from "../../../../app/chessboard/chessboard/move-result";
import ChessGameFactory from "../../chess-game-factory";
...
{  
  ...
  //#PGN
  public static parsePGN(pgn: string): {states: Array<IChessGame>, moveStack: Array<MoveResult>, pgnHeaders: PgnHeaders}
  {       
    ...
    return {states, moveStack, pgnHeaders}
  }
}
